...
var l_itvhaydy=setInterval(function(){
    if(myid!=null){
        ...
        $("#users .uzr.haydy1 .fitimg.u-pic").append('<img class="haydy_star1" src="https://up6.cc/2023/02/167579621323341.png">');
		$("#users .uzr.haydy1 span.u-topic").after('<img id="mystory1" class="My_vedio1" title="ستوري" style="float: right;width: 20px;margin-top: 0px;margin-right: 5px;cursor: pointer;" src="https://i.ibb.co/47VS4nY/image.png">');
        $("#users .uzr.haydy1 span.uhash, #users .uzr.haydy1 img.co").hide(); 
        ...
        $("div#users .uzr.haydy1 .My_vedio1").click(function(){
        $("#movon1").show();
