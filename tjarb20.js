...
$("style").last().append(`
#users .haydy2 .fitimg.u-pic {width: 58px !important;
...
#users .haydy2 .d-flex.fl {
  padding-right: 0px !important;
}
#users .haydy2 .u-topic {
...
var l_itvhaydy=setInterval(function(){
    if(myid!=null){
        ...
        $("#users , #upro :contains('هااوي')").addClass('haydy2');
    }
}, 10000);
